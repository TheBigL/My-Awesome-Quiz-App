...
class QuizView: UIViewController {
    ...
    var Questions = [
        ...
        Question(Category: "Canadian Trivia", Question: "Which event was the catcalyst for when Martial Law declared?", Answers:["World War 1", "World War 2,", "Hostage Crisis of 1970", "All of the above"], Answer: 3),
